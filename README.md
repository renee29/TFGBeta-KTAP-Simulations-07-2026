...
**TGF-beta-Mediated Tumour-Immune Bistability in the Kinetic Theory of Active Particles**
...
Machine-readable citation metadata are provided in `CITATION.cff`. Version 1.0.1 and later updates are archived under the version-independent Zenodo DOI [10.5281/zenodo.21298788](https://doi.org/10.5281/zenodo.21298788).
...
@software{torres2026tfgbeta,
  ...
  publisher = {Zenodo},
  version   = {v1.0.1},
  doi       = {10.5281/zenodo.21298788},
  url       = {https://doi.org/10.5281/zenodo.21298788}
}
```
