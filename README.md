...
<!-- After the Zenodo archive is created, replace the DOI badge above with:
...
Previews generated by `run_all_figures("release")`, shown here as a quick visual reference. Running the scripts also regenerates the individual panels and the `.mat` data records.

| Figure | Preview |
|---|---|
| **S1** — bifurcation diagram and time series | ![S1 preview](assets/previews/S1_preview.png) |
| **S2** — basins and intervention trajectories | ![S2 preview](assets/previews/S2_preview.png) |
| **S3** — robustness in (λ₁, β) | ![S3 preview](assets/previews/S3_preview.png) |
| **S4** — eigenvalue continuation | ![S4 preview](assets/previews/S4_preview.png) |
