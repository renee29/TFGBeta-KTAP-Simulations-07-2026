...
function plot_panel_a(ax, basin, cfg)
    ...
    xlabel(ax, 'Initial tumor load $X(0)$', 'Interpreter', 'latex', 'FontSize', 18, 'Color', cfg.colors.black);
    ...
    text(ax, 0.5, 0.085, {'Tumor escape'}, ...
...
function plot_panel_b(ax, treatment, p, ic, cfg)
    ...
    ylabel(ax, 'Tumor density $X(t)$', 'Interpreter', 'latex', 'FontSize', 18, 'Color', cfg.colors.black);
